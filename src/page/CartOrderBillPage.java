...
//        panel01.setBackground(Color.gray);
    ...
    public void printCart(JPanel panel) {
        ...
        for (int i = 0; i < mCart.mCartItem.size(); i++) {
            ...
            panel05.setBounds(0, 30 + (i * 5), 500, 5);
            JLabel label05 = new JLabel("   " + mCart.mCartItem.get(i).getCarID() + "          "
        ...
        panel06.setBounds(0, 30 + (mCart.mCartItem.size() * 5), 500, 5);
